            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-6 mb-4">
                        ...
                        <p className="mt-3" style={{ lineHeight: '1.8rem' }}>
                            Una forma profunda y moderna de estudiar la Biblia.
                            Inspiración y conocimiento al alcance de todos.
                        </p>
                    </div>
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="mt-3" style={{ lineHeight: '1.8rem' }}>
                            Encuentra inspiración diaria y noticias en nuestras
                            redes sociales.
                        </p>
