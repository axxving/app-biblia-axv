            ...
            <div className="container">
                ...
                <div className="text-center mb-5">
                    ...
                    <p className="lead text-muted">
                        Sumérgete en la palabra de Dios con herramientas únicas
                        y versiones adaptadas a tus necesidades.
                    </p>
                </div>
                    ...
                    <div className="col-lg-6">
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body d-flex align-items-center">
                                ...
                                ></i>
                                <div>
                                    <h5 className="fw-bold">Modo de Lectura</h5>
                        ...
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted">
                                        Encuentra versículos y temas específicos
                                        con herramientas de búsqueda precisa.
                                    </p>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body text-center">
                                ...
                                <p className="text-muted">
                                    La versión clásica para un estudio profundo
                                    y tradicional.
                                </p>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body text-center">
                                ...
                                <p className="text-muted">
                                    Lenguaje moderno y accesible para todos los
                                    lectores.
                                </p>
                                <button className="btn btn-outline-primary btn-sm">
                                    Leer Ahora
